...
'''
предположительно, модуль призван содержать функционал отправки приглащениям пользователям целевой группы в 
другие группы
'''
...
for member in members['users']:
    ...
    try:
        ...
        if s.message == 'Captcha needed':
            captcha_inputted = app_info.handling_captcha_exeption(s)
