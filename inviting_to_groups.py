...
group_id_to_invite_in = 'mgorkymumiytrollbar'
id_in = 126912469
offset = 1000
...
is_invited_users = api.groups.getInvitedUsers(group_id = id_in)[1:]
...
for member in members['users']:
    ...
    try:
        result = api.groups.invite(group_id = 126912469, user_id=member['uid'])
        print (result)
